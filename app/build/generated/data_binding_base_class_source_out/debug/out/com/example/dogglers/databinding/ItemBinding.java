...
public final class ItemBinding implements ViewBinding {
  ...
  private ItemBinding(@NonNull MaterialCardView rootView, @NonNull TextView dogAge,
  ...
  public static ItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemBinding((MaterialCardView) rootView, dogAge, dogHobbies, dogImage, dogName);
    }
